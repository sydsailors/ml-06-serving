...
uv run fastapi dev src/mlstudio/serve_sailors.py      # development (auto-reload)
uv run fastapi run src/mlstudio/serve_sailors.py      # production

- OR -

uv run uvicorn mlstudio.serve_sailors:app --reload    # development (auto-reload)
uv run uvicorn mlstudio.serve_sailors:app             # production
...
def predict_from_features(
    ...
    LOG.info(f"Prediction made from features {features}: {label}")
